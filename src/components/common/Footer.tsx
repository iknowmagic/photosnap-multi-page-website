  ...
  return (
    <footer className="bg-black px-8 md:px-10 lg:px-40 py-14 md:py-12 lg:py-14 text-white">
      <div className="gap-y-10 md:gap-y-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        ...
        {/* CTA Button */}
        <div className="md:justify-self-end md:self-start text-center md:text-right">
        ...
        {/* Copyright */}
        <div className="md:justify-self-end md:self-end opacity-50 text-sm text-center md:text-right">
